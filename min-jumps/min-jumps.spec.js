...
describe('min number of jumps', () => {
	it('returns the min # of jumps to cross an array of positive integers - [1,1]', () => {
		expect(minJumps(test1)).to.equal(1);
	});

	it('returns the min # of jumps to cross an array of positive integers - [6,3,2,1]', () => {
